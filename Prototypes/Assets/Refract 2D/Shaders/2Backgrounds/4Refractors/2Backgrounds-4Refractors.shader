Shader "Refract2D/2 Backgrounds/4 Refractors" {
	...
	Properties {
		...
		_DistortionMap3 ("Distortion Map", 2D) = "" {}	//Receive input from a Texture on Texture Unit 4
	...
	SubShader {
		...
		Pass {
			...
			uniform sampler2D _DistortionMap3;				//Define _DistortionMap3 from Texture Unit 4 to be sampled in 2D
			...
			fixed4 frag(VertexToFragment i) : COLOR {
				...
				float distort = distortion+distortion2+distortion3+distortion4;	//For speed
